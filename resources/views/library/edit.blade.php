...
<body>
    <div class="card">
        ...
        <form action="{{ route('library.update', $book->id) }}" method="POST">
            ...
            <div class="form-grid">
                ...
                <div class="form-group">
                    ...
                    <select name="category">
                        ...
                        <option value="Geography"   {{ old('category', $book->category) == 'Geography'   ? 'selected' : '' }}>Geography</option>
                        <option value="English"     {{ old('category', $book->category) == 'English'     ? 'selected' : '' }}>English</option>
                        <option value="Hindi"       {{ old('category', $book->category) == 'Hindi'       ? 'selected' : '' }}>Hindi</option>
                        <option value="Computer"    {{ old('category', $book->category) == 'Computer'    ? 'selected' : '' }}>Computer</option>
            ...
            <button type="submit" class="btn-update">✏️ Update Book</button>
        </form>
    </div>
</body>
</html>